...
public class EASS_HAQUE {
  ...
  String filename= "D:/CODING/EESS HAQUE/OUTPUT/primary"+"_"+inputfilename+"_"+date+".txt";
   String filename1= "D:/CODING/EESS HAQUE/OUTPUT/spare"+"_"+inputfilename+"_"+date+".txt";
   
    String filename2= "D:/CODING/EESS HAQUE/OUTPUT/energyEASS"+"_"+inputfilename+"_"+date+".txt";
    String filename3= "D:/CODING/EESS HAQUE/OUTPUT/tasksEASS"+"_"+inputfilename+"_"+date+".txt";
