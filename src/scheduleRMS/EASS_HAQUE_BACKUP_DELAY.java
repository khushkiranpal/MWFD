...
public class EASS_HAQUE_BACKUP_DELAY {
	...
	*/
    ...
    String filename= outputFolder+"primary"+"_"+inputfilename+"_"+date+".txt";
    String filename1= outputFolder+"spare"+"_"+inputfilename+"_"+date+".txt";
   
    String filename2= outputFolder+"energyEASS"+"_"+inputfilename+"_"+date+".txt";
    String filename3= outputFolder+"tasksEASS"+"_"+inputfilename+"_"+date+".txt";
...
//	   writer_spare.write(spareEndTime+"    spareEndTime\n");
 ...
 //   writer_spare.close();
    writer_energy.close();
     writer_tasks.close();
    System.out.println("success EASS");
	}
