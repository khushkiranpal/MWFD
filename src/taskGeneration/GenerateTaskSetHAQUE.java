...
public class GenerateTaskSetHAQUE {
   ...
   //   	System.out.print("Enter no. of processors\t");
    	...
    	long hyperperiod_factor= input.nextLong();
    ...
    //	System.out.println(" FOR IMPLICIT , Press 0  OR \n    FOR CONSTRAINED , Press -1");
    	...
    	int n=  15;//input.nextInt(); // NUMBER OF TASKS    15;  //(int)(Utotal/taskUti) ;  
   ...
   //	 System.out.println("Enter 1 for UUnifast  and 2 for Sporadic");
        ...
        if (deadlineModel==0)
        {
         filename = "D:/CODING/EESS HAQUE/TASKSET/IMPLICIT_TOT_SETS_"+TOTAL_NUM_TASKSETS+"_n_"+n+"_MAX_P_"+MAX_PERIOD+"_Utotal_"+Utotal+"_"+date+".txt";
        }
        else
        {
        	filename = "D:/CODING/EESS HAQUE/TASKSET/CONSTRAINED_TOT_SETS_"+TOTAL_NUM_TASKSETS+"_n_"+n+"_MAX_P_"+MAX_PERIOD+"_Utotal_"+Utotal+"_"+date+".txt";
